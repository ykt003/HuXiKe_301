...
public class DBUtil {
	...
	public void insertDataToScoreTable(ContentValues values) {
	mSQLiteDatabase.insert(SQLHelper.TABLE_SCORES, null, values);
	}
	/**
	 * 更新数据
	 * 
	...
	public void updateDataToScoreTable(ContentValues values,String whereClause,
			String[]whereArgs){
		mSQLiteDatabase.update(SQLHelper.TABLE_SCORES, values, whereClause, whereArgs);
	...
	public void deleteDataToScoreTable(String whereClause, String[] whereArgs) {
		mSQLiteDatabase
				.delete(SQLHelper.TABLE_SCORES, whereClause, whereArgs);
	}
	...
	public Cursor selectDataToScoreTable(String[] columns, String selection,
			String[] selectionArgs, String groupBy, String having,
			String orderBy) {
		Cursor cursor = mSQLiteDatabase.query(SQLHelper.TABLE_SCORES,columns, selection, selectionArgs, groupBy, having, orderBy);
		return cursor;
	}
}